...
from app.deps import get_current_household_id, get_household_crop_ids
...
def list_my_reference(
    ...
    return [to_reference_out(r, household.organization_id if household else None) for r in rows]
